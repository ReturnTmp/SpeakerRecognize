...
def eval_model(model,train_batch_size=c.BATCH_SIZE * c.TRIPLET_PER_BATCH, test_dir= c.OUTPUT_DIR, check_partial=False, gru_model=None):
...
if __name__ == '__main__':
    ...
    base_model = convolutional_model((160, 64, 1), 48, 160)
    x = base_model.output
    x = Dense(141, activation='softmax',name='softmax_layer')(x)
