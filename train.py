...
def main():
    ...
    if len(libri) == 0:
        ...
        preprocess_and_save(c.DATASET_DIR, c.OUTPUT_DIR)
        libri = data_catalog(libri_dir)
    ...
    print(x_test.shape[1:], batch_size, num_frames, no_of_speakers)
    ...
    while True:
        ...
        if grad_steps  % c.SAVE_PER_EPOCHS == 0:
            utils.create_dir_and_delete_content(c.CHECKPOINT_FOLDER)
